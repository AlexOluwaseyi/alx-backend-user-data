...
if __name__ == "__main__":
    r = requests.get('http://127.0.0.1:3456/api/v1/users', headers={ 'Authorization': "HBTN" })
    ...
    try:
        ...
        if error_value is None:
            print("Missing 'erroAPI_HOST=0.0.0.0 API_PORT=5000 ./main_1.pyr' key in the JSON: {}".format(r_json))
            exit(1)
